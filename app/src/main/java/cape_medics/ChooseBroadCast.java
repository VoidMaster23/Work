...
import com.example.cape_medics.BroadCast;
        ...
        //fill from db and have them change on spinner change
            jobType.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Log.e("job", job);
                    if (connected) {
                        if (job != null && unit != null && job.equals("Event") && unit.equals("Rigging")) {
    ...
    class AsyncT extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                chooseBroadcast.put("Job_Name", job);
                chooseBroadcast.put("Unit_Type", unit);

                List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();
                nameValuePairs.add(new BasicNameValuePair("req", chooseBroadcast.toString()));

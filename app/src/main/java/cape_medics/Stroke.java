...
public class Stroke extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fd_btnYes = view.findViewById(R.id.btnCan2);
        fd_btnNo = view.findViewById(R.id.btnAtt3);
        aw_btnYes = view.findViewById(R.id.btnAtt1);
        aw_btnNo = view.findViewById(R.id.btnAtt4);
        sd_btnYes = view.findViewById(R.id.btnAtt2);
        sd_btnNo = view.findViewById(R.id.btnAtt3);

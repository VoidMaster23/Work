...
public class ALS_ICU_AMB extends AppCompatActivity {
    ...
    public void Send(View v){
        try{
            als_icu_amb.put("Vehicle Number", String.valueOf(VehicleNumber));
            als_icu_amb.put("Driver", driver.toString());
            als_icu_amb.put("Controller", controller.toString());
            als_icu_amb.put("Checked By", checkedBy.toString());
            als_icu_amb.put("Inspection Date", Date);
            als_icu_amb.put("Inspection Time", inspectionTime.toString());
        ...
        for (int i = 0; i<checkBoxList.size();i++){
            if(!checkBoxList.get(i).isChecked()){
                try{
                    als_icu_amb.put(checkBoxList.get(i).getText().toString(),commentList.get(i).toString());
                }catch(Exception e){}
            }
        }
    }
